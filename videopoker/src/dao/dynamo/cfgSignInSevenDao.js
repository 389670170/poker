...
module.exports = {
    tableName: "videopoker_cfg_sign_in_seven",
    updateAchievementByIdAndIdx: async function (kid, id, day_total, reward_type1, reward_num1, reward_type2, reward_num2, pay_level, billing_id) {
        let params = {
            TableName: this.tableName,
            Key: {id: id, kid: kid},
            UpdateExpression: "SET day_total = :day_total, reward_type1 = :reward_type1,reward_num1 = :reward_num1,reward_type2 = :reward_type2,reward_num2 = :reward_num2,pay_level =:pay_level,billing_id=:billing_id",
