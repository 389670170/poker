...
module.exports = {
     ...
     * 请求成就
     * @param userId
     * @returns {Promise<{AchievementPoints: number, AchievementList: Array}>}
     */
     ...
     * @param userId
     * @param achievementId
     * @returns {Promise<{achievement: {achievementId: *, title: *, description: string | * | void, achievementPoints: number, achievementReward: {rewardType: number, rewardNum: number}, nowProgress: number, progress: number}, achievementReward: {rewardType: number, rewardNum: number, achievementPoints: number}, finishAchievementNumber: number}>}
     */
    finishAchievement: async function (userId, achievementId) {
     ...
     * 请求任务
     * @param userId
     * @returns {Promise<{missionList: Array, missionWaitInfo: Array, freeChance: boolean}>}
     */
     ...
     * @param userId
     * @param missionId
     * @returns {Promise<{reward: number, time: *}>}
     */
    finishMission: async function (userId, missionId) {
     ...
     * @param userId
     * @param missionId
     * @returns {Promise<{mission: {title: string | * | void, description: string | * | void, coins: number, nowProgress: number, progress: number, missionId: number}}>}
     */
