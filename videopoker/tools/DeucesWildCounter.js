...
class DeucesWildCounter {
    ...
    static hasStraightFlushWild(hand) {
        return DeucesWildCounter.hasStraightWild(hand) && DeucesWildCounter.hasFlushWild(hand);
    }
...
exports.DeucesWildCounter = DeucesWildCounter;
