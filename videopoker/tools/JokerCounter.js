...
class JokerCounter {
    ...
    static hasStraightFlushWild(hand) {
        return (JokerCounter.hasStraightWild(hand) && JokerCounter.hasFlushWild(hand));
    }
    ...
    static hasFlushWild(hand) {
        for (let i = 0; i < 4; i++) {
            if (hand.suitCounts[i] + hand.wildCnt === 5)
                return true;
        }
        return false;
    }
    static hasStraightWild(hand) {
        if ((hand.singleCnt == 4 && hand.wildCnt == 1) || hand.singleCnt == 5) {
    ...
    static hasTwoPairWild(hand) {
        return ((hand.pairCnt === 2 && hand.wildCnt === 0) || (hand.singleCnt === 2 && hand.pairCnt === 1 && hand.wildCnt === 1));
    }
...
exports.JokerCounter = JokerCounter;
