...
class TwoWaysRoyalCounter {
    ...
    static hasStraightFlush(hand) {
        for (let i = 0; i < 4; i++) {
            if (hand.suitCounts[i] >= 5) {
                let v = TwoWaysRoyalCounter.helperHasStraight(hand.cardCounts, 13 * i);
                if (v != null) {
                    return [v, i];
                }
            }
    ...
    static hasStraight(hand) {
        for (let i = 0; i < 4; i++) {
            let v = TwoWaysRoyalCounter.helperHasStraight(hand.rankCounts, 0);
            if (v != null) {
                return [v];
            }
        }
    ...
    static hasJacksOrBetter(hand) {
        let v = TwoWaysRoyalCounter.hasPair(hand);
        if (v != null) {
            if (v[0] >= 10) {
                return true;
            }
...
exports.TwoWaysRoyalCounter = TwoWaysRoyalCounter;
